...
namespace ns1
{
    ...
    /// <summary>
    /// Represents the func1 flow invoked function.
    /// </summary>
    public class func1
    {
        private readonly ILogger<func1> logger;

        public func1(ILoggerFactory loggerFactory)
        {
            logger = loggerFactory.CreateLogger<func1>();
        }
